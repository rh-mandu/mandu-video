...
import {MediaConverterAdapter2} from "./MediaConverterAdapter2.ts";
...
export function createMediaConverterAdapter2():VideoConverter{
    const config: LambdaClientConfig = {
        region: "ap-northeast-2",
        requestHandler: new NodeHttpHandler({
            httpsAgent: new HttpsProxyAgent("http://172.31.46.254:8888")
    ...
    return new MediaConverterAdapter2(client);
}